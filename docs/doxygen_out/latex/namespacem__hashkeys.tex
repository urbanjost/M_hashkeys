...
program demo\+\_\+luhn\+\_\+checksum use M\+\_\+hashkeys, only \+: luhn\+\_\+checksum implicit none character(len=\+:),allocatable \+:: ccards(\+:), string integer \+:: i, j write($\ast$,$\ast$)\textquotesingle{}G\+O\+OD V\+A\+L\+U\+ES\textquotesingle{} ccards=\mbox{[} character(len=20) \+:: \textquotesingle{}79927398713\textquotesingle{}, \textquotesingle{}49927398716\textquotesingle{}, \textquotesingle{}1234567812345670\textquotesingle{} \mbox{]} call \mbox{\hyperlink{M__hashkeys_8f90_a687fd4f04a046f9f03b0706d47b114cc}{checkem()}} write($\ast$,$\ast$)\textquotesingle{}B\+AD V\+A\+L\+U\+ES\textquotesingle{} ccards=\mbox{[} character(len=20) \+:: \& \textquotesingle{}79927398710\textquotesingle{},\textquotesingle{}79927398711\textquotesingle{},\textquotesingle{}79927398712\textquotesingle{},\textquotesingle{}79927398714\textquotesingle{}, \& \textquotesingle{}79927398715\textquotesingle{},\textquotesingle{}79927398716\textquotesingle{},\textquotesingle{}79927398717\textquotesingle{},\textquotesingle{}79927398718\textquotesingle{},\textquotesingle{}79927398719\textquotesingle{}, \& \textquotesingle{}49927398717\textquotesingle{}, \textquotesingle{}1234567812345678\textquotesingle{} \mbox{]} call \mbox{\hyperlink{M__hashkeys_8f90_a687fd4f04a046f9f03b0706d47b114cc}{checkem()}} contains subroutine checkem ! validate these numbers do i=1,size(ccards) j=len(trim(ccards(i))) string=luhn\+\_\+checksum(ccards(i)(\+:j-\/1)) write($\ast$,\textquotesingle{}(a,1x,a,1x,l1)\textquotesingle{})ccards(i),string,ccards(i).eq.\+string enddo

string=\textquotesingle{}123456 781-\/234-\/567\textquotesingle{} write($\ast$,$\ast$)\textquotesingle{}from \textquotesingle{},string,\textquotesingle{} got \textquotesingle{},luhn\+\_\+checksum(string),\textquotesingle{} which should be 1234567812345670\textquotesingle{} end subroutine checkem end program demo\+\_\+luhn\+\_\+checksum Here is the caller graph for this function\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
